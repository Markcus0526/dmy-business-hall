...
public class CompareBrandActivity extends Activity {
    ...
    private JsonHttpResponseHandler handler = new JsonHttpResponseHandler()
    {
        ...
        public void onSuccess(JSONObject jsonData)
        {
            ...
            if (nRet == 0)
            {
            	...
            	{
            		mAdapter = new PhoneSpecAdapter(CompareBrandActivity.this, 0, arrDatas);
        ...
        public void onFinish()
        {
        	dialog.dismiss();
            if (result == 2)
                GlobalData.showToast(CompareBrandActivity.this, getString(R.string.service_error));
            else if (result == 0)
                GlobalData.showToast(CompareBrandActivity.this, getString(R.string.network_error));
        }
    };
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (GlobalData.getTempID(CompareBrandActivity.this) == 1)
            setContentView(R.layout.activity_comparebrand);
        else if (GlobalData.getTempID(CompareBrandActivity.this) == 2)
            setContentView(R.layout.activity_comparebrand_2);
        else
            setContentView(R.layout.activity_comparebrand);

        rlMainBack = (RelativeLayout)findViewById(R.id.rlCompareBrandBack);
                ...
                new ViewTreeObserver.OnGlobalLayoutListener() {
                    public void onGlobalLayout() {
                        if (bInitialized == false)
                        {
                            ...
                            ResolutionSet._instance.iterateChild(findViewById(R.id.rlCompareBrandBack));
                            bInitialized = true;
                        }
                    }
                }
        ...
        dialog = ProgressDialog.show(
        		CompareBrandActivity.this,
        		"",
        		getString(R.string.waiting),
        		true,
        		false,
        		null);
        CommMgr.commService.getSameBrandList(handler, 
        		Long.toString(GlobalData.getUserID(CompareBrandActivity.this)), 
        		Long.toString(GlobalData.getBrandID(CompareBrandActivity.this)), 
        		Long.toString(GlobalData.getSpecID(CompareBrandActivity.this)));
    }

    private void initView()
    {
        imgKind = (ImageView) findViewById(R.id.imgBrand_Kind);
        imgKind.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CompareBrandActivity.this, CompareKindActivity.class);
                startActivity(intent);
                finish();
            }
        });

        imgBack = (ImageView) findViewById(R.id.imgBrand_Back);
        imgBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CompareBrandActivity.this, FeatureActivity.class);
                startActivity(intent);
                finish();
            }
        });
        
        listDatas = (ListView) findViewById(R.id.listCompareBrand_Datas);
    }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            rlBack.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(CompareBrandActivity.this, ImgListActivity.class);
