...
//                 }
        ...
        public static string han_cut(string val, int cut_len)
        {
            ...
            int linelen = val.IndexOf("%0A");
            if(linelen > 0)
                val = val.Substring(0, linelen);
        ...
        public static string GetNavLink(string navname, string rootUri)
        {
            ...
            switch (navname)
            {
                ...
                case "EditTag":
                    ...
                    break;
                case "Agent":
                    rst = rootUri + "Agt/AgentList";
                    break;
                case "AgentList":
                    rst = rootUri + "Agt/AgentList";
                    break;
                case "AddAgent":
                    rst = rootUri + "Agt/AddAgent";
                    break;
                case "EditAgent":
                    rst = rootUri + "Agt/EditAgent";
                    break;
                case "Hall":
                    rst = rootUri + "Hall/HallList";
                    break;
                case "HallList":
                    rst = rootUri + "Hall/HallList";
                    break;
                case "AddHall":
                    rst = rootUri + "Hall/AddHall";
                    break;
                case "EditHall":
                    rst = rootUri + "Hall/EditHall";
                    break;
                case "System":
                    rst = rootUri + "System/SysNoticeList";
                    break;
                case "SysNoticeList":
                    rst = rootUri + "System/EditSysNotice";
                    break;
                case "AddSysNotice":
                    rst = rootUri + "System/AddSysNotice";
                    break;
                case "EditSysNotice":
                    rst = rootUri + "Agt/EditAgent";
                    break;
                case "EditAPass":
                    rst = rootUri + "Agt/EditAPass";
                    break;
                case "EditLPass":
                    rst = rootUri + "Hall/EditLPass";
                    break;
        ...
        public static string GetFileSizeString(long nByte)
        {
            string strRet = "";

            if (nByte < 1024)
                strRet = Convert.ToString(nByte) + " B";
            else if ( nByte < 1024 * 1024 )
                strRet = String.Format("{0:0.0}", ((float)nByte / 1024)) + " KB";
            else if (nByte < 1024 * 1024 * 1024 )
                strRet = String.Format("{0:0.0}", ((float)nByte / 1024 / 1024)) + " MB";
