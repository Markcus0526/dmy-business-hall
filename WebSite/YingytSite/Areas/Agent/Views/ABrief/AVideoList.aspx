...
<div class="row">
	<div class="col-xs-12">
		...
		<div>
            <p>
                <a class="btn btn-white btn-info btn-bold" href="<%= ViewData["rootUri"] %>Agent/ABrief/AddAVideo">
				     	...
				     	},
				     	{
				     	    ...
				     	    fnRender: function (o, v) {   // o, v contains the object and value for the column
				     	        var rst = '<div class="hidden-sm hidden-xs action-buttons">' +
							        '<a class="green" href="' + rootUri + 'Agent/ABrief/EditAVideo/' + o.aData[6] + '"><i class="ace-icon fa fa-pencil bigger-130"></i>编辑</a>' +
