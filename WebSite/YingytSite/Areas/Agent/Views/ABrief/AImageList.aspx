...
<div class="row">
	<div class="col-xs-12">
        <p class="alert alert-info">
            ...
            温馨提示：只能支持JPG、PNG格式的图片。图片的最大大小为<b>4M</b>。<br />
            <b>来源</b>:区别营业厅图片和代理亲自上传的图片。
        </p>
		<div>
            <p>
                <a class="btn btn-white btn-info btn-bold" href="<%= ViewData["rootUri"] %>Agent/ABrief/AddAImage">
	                <i class="ace-icon fa fa-plus bigger-120 blue"></i>添加图片
                </a>
				...
				.dataTable({
				    ...
				    "aoColumnDefs": [
				     	...
				     	},
                        {
                            ...
                            fnRender: function (o, v) {   // o, v contains the object and value for the column
                                var tmp = "<img src='" + rootUri + o.aData[1] +  "' height='120px'  />";
                                return tmp;
                            },
                            sClass: 'left'
                        },
				     	{
				     	    ...
				     	    fnRender: function (o, v) {   // o, v contains the object and value for the column
				     	        var rst = '<div class="hidden-sm hidden-xs action-buttons">' +
							        '<a class="green" href="' + rootUri + 'Agent/ABrief/EditAImage/' + o.aData[5] + '"><i class="ace-icon fa fa-pencil bigger-130"></i>编辑</a>' +
                                    '<a class="red" href="#" onclick="processDel(' + o.aData[5] + ')"><i class="ace-icon fa fa-trash-o bigger-130"></i>删除</a>' +
						        '</div>';

//				     	        var rst = '<a class="btn btn-xs btn-info" href="' + rootUri + 'Agent/ABrief/EditAImage/' + o.aData[5] + '">' +
		            ...
		            bootbox.dialog({
		                ...
		                buttons: {
		                    ...
		                    main: {
		                        ...
		                        callback: function () {
		                            $.ajax({
		                                url: rootUri + "Agent/ABrief/DeleteAImage",
		                                data: {
		                                    "delids": selected_id
		                                },
		                                type: "post",
