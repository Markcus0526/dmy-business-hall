		...
		<form class="form-horizontal" role="form" id="validation-form">
			...
			<div class="clearfix form-actions">
				<div class="col-md-offset-3 col-md-9">
					...
					&nbsp; &nbsp; &nbsp;
					<button class="btn" type="button" onclick="window.location='<%= ViewData["rootUri"] %>Agent/Abrief/<% if (ViewData["uid"] != null) { %>EditAImage/<%= ViewData["uid"] %> <% } else { %>AddAImage <% } %>'">
	...
	<script type="text/javascript">
	    function redirectToListPage(status) {
	        if (status.indexOf("error") != -1) {
	            ...
	            window.history.go(-1);
	            //window.location = rootUri + "Agent/ABrief/AImageList";
	        }
	    }
	    jQuery(function ($) {
	        $('.loading-btn')
