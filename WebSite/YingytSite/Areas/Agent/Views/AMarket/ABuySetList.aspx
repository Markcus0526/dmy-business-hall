	...
	<script type="text/javascript">
	    ...
	    jQuery(function ($) {
			...
			.dataTable({
			    "bServerSide": true,
			    "bProcessing": true,
			    "sAjaxSource": rootUri + "Agent/AMarket/RetrieveABuySetList",
			    "oLanguage": {
			    ...
			    "aoColumnDefs": [
				 	...
				 	},
				 	{
				 	    ...
				 	    fnRender: function (o, v) {   // o, v contains the object and value for the column
				 	        ...
				 	        rst += '<a class="blue " href="<%= ViewData["rootUri"] %>Agent/AMarket/AManageBuySet/' + o.aData[6] + '"><i class="ace-icon fa fa-briefcase bigger-130"></i>选择图片</a>' +
						        '</div>';
	    ...
	    function search_data() {
	        ...
	        oSettings = oTable.fnSettings();
	        oSettings.sAjaxSource = rootUri + "Agent/AMarket/RetrieveABuySetList" + "?lobby=" + lobby_id + "&brand=" + brand_id;
