...
<div class="row">
	<div class="col-xs-12">
        <p class="alert alert-info">
            ...
            <b>无图片</b>：不存在对应该手机型号的图片的情况，(在营业厅没设置图片，代理也没设置的状态。请抓紧设置图片。)<br />
            三张以下航的图片显示（外X张）
        </p>
			...
			<table id="tbldata" class="table table-striped table-bordered table-hover">
				...
				<tbody>
                    <!--<tr>
			            ...
			            <td>S930</td>
			            <td>
                        <a href="#" target="_blank"><img src="<%= ViewData["rootUri"] %>content/img/f1.jpg" style="max-height:100px;" /></a>
                        <a href="#" target="_blank"><img src="<%= ViewData["rootUri"] %>content/img/f1.jpg" style="max-height:100px;" /></a>
                        <a href="#" target="_blank"><img src="<%= ViewData["rootUri"] %>content/img/f1.jpg" style="max-height:100px;" /></a>
                        </td>
			            <td class="hidden-480">
                        ...
                        <td>
						    <div class="hidden-sm hidden-xs action-buttons">
							    ...
							    <a class="blue " href="<%= ViewData["rootUri"] %>Agent/AMarket/AManageBrightSpot/1"><i class="ace-icon fa fa-briefcase bigger-130"></i>选择图片</a>
						    </div>
                        </td>
                    </tr>
                    <tr>
	...
	<script type="text/javascript">
	    ...
	    jQuery(function ($) {
			...
			.dataTable({
			    "bServerSide": true,
			    "bProcessing": true,
			    "sAjaxSource": rootUri + "Agent/AMarket/RetrieveABrightSpotList",
			    "oLanguage": {
			    ...
			    "aoColumnDefs": [
			        {
				 	...
				 	},
				 	{
				 	    ...
				 	    fnRender: function (o, v) {   // o, v contains the object and value for the column
				 	        ...
				 	        rst += '<a class="blue " href="<%= ViewData["rootUri"] %>Agent/AMarket/AManageBrightSpot/' + o.aData[6] + '"><i class="ace-icon fa fa-briefcase bigger-130"></i>选择图片</a>' +
						        '</div>';
	    ...
	    function search_data() {
	        ...
	        oSettings = oTable.fnSettings();
	        oSettings.sAjaxSource = rootUri + "Agent/AMarket/RetrieveABrightSpotList" + "?lobby=" + lobby_id + "&brand=" + brand_id;
