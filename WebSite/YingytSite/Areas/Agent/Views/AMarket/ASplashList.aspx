	...
	<script type="text/javascript">
	    ...
	    jQuery(function ($) {
			...
			.dataTable({
			    "bServerSide": true,
			    "bProcessing": true,
			    "sAjaxSource": rootUri + "Agent/AMarket/RetrieveASplashList",
			    "oLanguage": {
			    ...
			    "aoColumnDefs": [
				 	...
				 	},
				 	{
				 	    ...
				 	    fnRender: function (o, v) {   // o, v contains the object and value for the column
				 	        ...
				 	        rst += '<a class="red" href="<%= ViewData["rootUri"] %>Agent/ABrief/AddAMarketImage/' + o.aData[6] + '" ><i class="ace-icon fa fa-upload bigger-130"></i>上传图片</a>';
	    ...
	    function search_data() {
	        ...
	        oSettings = oTable.fnSettings();
	        oSettings.sAjaxSource = rootUri + "Agent/AMarket/RetrieveASplashList" + "?lobby=" + lobby_id + "&brand=" + brand_id;
