			...
			<table id="tbldata" class="table table-striped table-bordered table-hover">
				...
				<tbody>
                    <!--<tr>
			            ...
			            <td>Lenovo</td>
			            <td>S930</td>
			            <td>291903842.flv &nbsp;&nbsp;<a href="javascript:(0);" onclick="showVideo();"><i class="ace-icon fa fa-play"></i>播放</a></td>
			            <td class="hidden-480">
				            <span class="label label-warning">强制播放</span>
			            </td>
                        <td>
						    <div class="hidden-sm hidden-xs action-buttons">
                                <a class="orange" href="javascript:void(0);" onclick="processUnBlock(1);"><i class="ace-icon fa fa-unlock bigger-130"></i>解冻播放</a>
							    <a class="blue " href="#modal-table" role="button" data-toggle="modal"><i class="ace-icon fa fa-briefcase bigger-130"></i>选择视频</a>
						    </div>
                        </td>
                    </tr>
                    <tr>
			            ...
			            <td>291903842.flv &nbsp;&nbsp;<a href="javascript:(0);" onclick="showVideo();"><i class="ace-icon fa fa-play"></i>播放</a></td>
			            <td class="hidden-480">
				            <span class="label label-success">播放营业厅视频</span>
			            </td>
                        <td>
						    <div class="hidden-sm hidden-xs action-buttons">
                                <a class="orange" href="javascript:void(0);" onclick="processBlock(2);"><i class="ace-icon fa fa-lock bigger-130"></i>强制播放</a>
							    <a class="blue " href="#modal-table" role="button" data-toggle="modal"><i class="ace-icon fa fa-briefcase bigger-130"></i>选择视频</a>
						    </div>
                        </td>
                    </tr>
                    <tr>
			            ...
			            <td>中兴</td>
			            <td>T95</td>
			            <td>默认中兴T95演示视频.flv &nbsp;&nbsp;<a href="javascript:(0);" onclick="showVideo();"><i class="ace-icon fa fa-play"></i>播放</a></td>
			            <td class="hidden-480">
				            <span class="label label-info arrowed arrowed-righ">默认</span>
			            </td>
                        <td>
						    <div class="hidden-sm hidden-xs action-buttons">
                                <a class="orange" href="javascript:void(0);" onclick="processBlock(3);"><i class="ace-icon fa fa-lock bigger-130"></i>强制播放</a>
							    <a class="blue " href="#modal-table" role="button" data-toggle="modal"><i class="ace-icon fa fa-briefcase bigger-130"></i>选择视频</a>
						    </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
						    <div class="hidden-sm hidden-xs action-buttons">
                                <a class="red" target="_blank" href="<%= ViewData["rootUri"] %>Agent/ABrief/AddAVideo" ><i class="ace-icon fa fa-upload bigger-130"></i>上传视频</a>
							    <a class="blue " href="#modal-table" role="button" data-toggle="modal"><i class="ace-icon fa fa-briefcase bigger-130"></i>选择视频</a>
						    </div>
                        </td>
                    </tr>-->
	...
	<script type="text/javascript">
		...
		jQuery(function ($) {
			...
			.dataTable({
			    "bServerSide": true,
			    "bProcessing": true,
			    "sAjaxSource": rootUri + "Agent/AMarket/RetrieveAVideoList",
			    "oLanguage": {
			    ...
			    "aoColumnDefs": [
				 	...
				 	},
				 	{
				 	    ...
				 	    fnRender: function (o, v) {   // o, v contains the object and value for the column
				 	        ...
				 	        rst += '<a class="red" href="<%= ViewData["rootUri"] %>Agent/ABrief/AddAMarketVideo/' + o.aData[6] + '" ><i class="ace-icon fa fa-upload bigger-130"></i>上传视频</a>';
		...
		function search_data() {
		    ...
		    oSettings = oTable.fnSettings();
		    oSettings.sAjaxSource = rootUri + "Agent/AMarket/RetrieveAVideoList" + "?lobby=" + lobby_id + "&brand=" + brand_id;
