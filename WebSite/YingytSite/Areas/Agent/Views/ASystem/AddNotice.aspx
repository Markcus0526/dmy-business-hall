...
<div class="page-header">
	<h1>
        ...
        <a class="btn btn-white btn-default btn-round" onclick="window.location='<%= ViewData["rootUri"] %>Agent/ASystem/NoticeList'" style="float:right">
		...
		<form class="form-horizontal" role="form" id="validation-form">
			...
			<div class="form-group" id="categorypart">
                ...
                <div class="col-sm-2">
                    <div class="clearfix" id="categorylistpart">
					    <select class="select2" id="categorylist" name="categorylist" multiple class = "form-control" onchange="proc_category_change();" data-placeholder="请输入题目" data-required = 1>
				        </select>
                    </div>
                </div>
			</div>
			...
			<div class="clearfix form-actions">
				<div class="col-md-offset-3 col-md-9">
					...
					&nbsp; &nbsp; &nbsp;
					<button class="btn" type="button" onclick="window.location='<%= ViewData["rootUri"] %>Agent/ASystem/<% if (ViewData["uid"] != null) { %>EditNotice/<%= ViewData["uid"] %> <% } else { %>AddNotice <% } %> '">
	...
	<script type="text/javascript">
	    ...
	    function redirectToListPage(status) {
	        if (status.indexOf("error") != -1) {
	            ...
	            window.location = rootUri + "Agent/ASystem/NoticeList";
	        }
	    }
        ...
        function init_page()
        {
            ...
            <% if (ViewData["categorylist"] != null) { %>
                ...
                {
                    $("#ecatetype").val(1);
                    $('#categorylist').val(sysnew_range.split(","), true);
...
//	        $.validator.messages.equalTo = jQuery.validator.format("密码不一致.");
	    ...
	    function submitform() {
	        ...
	        $.ajax({
	            type: "POST",
	            url: rootUri + "ASystem/SubmitASysNotice",
	            dataType: "json",
        ...
        {
            var ehtml = "";
            ehtml += '<option value ="0" selected>全部营业厅</option>';
