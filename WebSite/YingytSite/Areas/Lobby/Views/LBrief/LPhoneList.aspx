					...
					$("#" + subgridTableId).jqGrid({
					    ...
					    {name:'myac2',index:'', width:80, fixed:true, sortable:false, resize:false, search:false,
						    ...
						    formatoptions:{ 
							    ...
							    delOptions:{recreateForm: true, beforeShowForm:beforeDeleteSpecCallback},
							    editformbutton:true, editOptions:{recreateForm: true, beforeShowForm:beforeEditSpecCallback}
						    }
					    },
				    ...
				    jQuery("#"+subgridTableId).jqGrid('navGrid',"#"+pager_id,
			            ...
			            },
				        {
					        ...
					        beforeShowForm : function(e) {
                                var id = e.find('#id_g').val();

                                $.ajax({
	                                url: rootUri + "Lobby/LBrief/GetAuthority",
	                                data: {
	                                    "id": id,
	                                    "type": "brand"
	                                },
	                                ...
	                                success: function (message) {
	                                    if (message == true) {
	                                        ...
	                                        toastr["error"]("没有权限，只能操作你添加的", "温馨敬告");
                                        }
	                                }
	                            });  
...
//						        style_edit_form(form);
				        ...
				        },
				        {
					        ...
					        recreateForm: true,
					        beforeShowForm : function(e) {
						        var id = e.find('#DelData').find('td').html();
...
//						form.data('styled', true);
			...
			function beforeDeleteCallback(e) {
                //alert(e.find('#DelData').find('td').html());
                var id = e.find('#DelData').find('td').html();
...
//				style_edit_form(form);
            ...
            function beforeDeleteSpecCallback(e) {
                //alert(e.find('#DelData').find('td').html());
                var id = e.find('#DelData').find('td').html();
...
//				form.data('styled', true);
			...
			function beforeEditSpecCallback(e) {
                //alert(e.find('#id_g').val());
                var id = e.find('#id_g').val();
