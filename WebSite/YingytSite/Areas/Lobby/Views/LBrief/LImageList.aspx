...
<div class="row">
	<div class="col-xs-12">
		...
		<div>
            <p>
                <a class="btn btn-white btn-info btn-bold" href="<%= ViewData["rootUri"] %>Lobby/LBrief/AddLImage">
                        ...
                        },
				     	{
				     	    ...
				     	    fnRender: function (o, v) {   // o, v contains the object and value for the column
				     	        ...
				     	        if (parseInt(o.aData[7], 10) == 1) {
							        ...
							        '<a class="green" href="' + rootUri + 'Lobby/LBrief/EditLImage/' + o.aData[5] + '"><i class="ace-icon fa fa-pencil bigger-130"></i>编辑</a>' +
                                    '<a class="red" href="#" onclick="processDel(' + o.aData[5] + ')"><i class="ace-icon fa fa-trash-o bigger-130"></i>删除</a>' +
						        '</div>';
				     	            //				     	        var rst = '<a class="btn btn-xs btn-info" href="' + rootUri + 'Lobby/LBrief/EditLImage/' + o.aData[5] + '">' +
