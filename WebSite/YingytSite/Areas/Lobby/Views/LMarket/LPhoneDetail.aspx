	...
	<script type="text/javascript">
	    ...
	    jQuery(function ($) {
			...
			.dataTable({
			    "bServerSide": true,
			    "bProcessing": true,
			    "sAjaxSource": rootUri + "Lobby/LMarket/RetrieveLPhoneDetail",
			    "oLanguage": {
			    ...
			    "aoColumnDefs": [
				 	...
				 	},
				 	{
				 	    ...
				 	    fnRender: function (o, v) {   // o, v contains the object and value for the column
				 	        ...
				 	        rst += '<a class="blue " href="<%= ViewData["rootUri"] %>Lobby/LMarket/LManagePhoneDetail/' + o.aData[11] + '"><i class="ace-icon fa fa-briefcase bigger-130"></i>修改详细信息</a>' +
				 	        '<a class="red " href="<%= ViewData["rootUri"] %>Lobby/LMarket/LManagePhoneRel/' + o.aData[11] + '"><i class="ace-icon fa fa-briefcase bigger-130"></i>修改类型范围</a>' +
						        '</div>';
	    ...
	    function search_data() {
	        ...
	        oSettings = oTable.fnSettings();
	        oSettings.sAjaxSource = rootUri + "Lobby/LMarket/RetrieveLPhoneDetail" + "?brand=" + brand_id;
