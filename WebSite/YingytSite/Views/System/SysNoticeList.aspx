...
<div class="row">
	<div class="col-xs-12">
        <p class="alert alert-info">
            ...
            温馨提示：向城市管理员、营业厅通知系统发布的信息<br />
            <b>通知分类</b>: 可以设置只向城市管理或者营业厅发送通知。
        </p>
		<div>
            <p>
                <a class="btn btn-white btn-info btn-bold" href="<%= ViewData["rootUri"] %>System/AddSysNotice">
                ...
                <a class="btn btn-white btn-warning btn-bold btnbatch" style="display:none;" id="btnbatchactivate" onclick="processShow();">
                    <i class="ace-icon fa fa-unlock bigger-120 orange"></i>批量显示
                </a>
                <a class="btn btn-white btn-warning btn-bold btnbatch" style="display:none;" id="btnbatchblock" onclick="processHide();">
                    <i class="ace-icon fa fa-lock bigger-120 orange"></i>批量不显示
                </a>
            </p>
		</div>
		...
		<script type="text/javascript">
		    ...
		    jQuery(function ($) {
				...
				.dataTable({
				    ...
				    "bProcessing": true,
				    "sAjaxSource": rootUri + "System/RetrieveSysNoticeList",
				    "oLanguage": {
				     		...
				     		},
                            {
                            ...
                            },
				     		{
				     		    ...
				     		    fnRender: function (o, v) {   // o, v contains the object and value for the column
				     		        ...
				     		        rst += '<a class="green" href="' + rootUri + 'System/EditSysNotice/' + o.aData[6] + '">' +
				     				        '<i class="ace-icon fa fa-pencil bigger-130"></i>编辑' +
				     				        '</a>';
				     		        switch (parseInt(o.aData[7], 10)) {
				     		            case 0:
				     		                rst += '<a class="orange" href="#" onclick="processShow(' + o.aData[6] + ')"><i class="ace-icon fa fa-unlock bigger-130"></i>显示</a>';
				     		                break;
				     		            case 1:
				     		                rst += '<a class="orange" href="#" onclick="processHide(' + o.aData[6] + ')"><i class="ace-icon fa fa-lock bigger-130"></i>不显示</a>';
				     		                break;
				     		        }
				     		        //rst += '<a class="orange" href="#"><i class="ace-icon fa fa-unlock bigger-130"></i>不显示</a>';
				     		        rst += '<a class="red" href="#" onclick="processDel(' + o.aData[6] + ')">' +
