...
<div class="page-header">
	<h1>
        ...
        <a class="btn btn-white btn-default btn-round" onclick="window.location='<%= ViewData["rootUri"] %>Hall/HallList'" style="float:right">
	...
	<div class="col-xs-12">
		<form class="form-horizontal" role="form" id="validation-form">
			<div class="form-group" <% if (ViewData["uid"] != null) { %>style="display:none"<% } %>>
				...
				<div class="col-sm-9">
                    <div class="clearfix">
					<input type="text" id="hallname" name="hallname" placeholder="请输入用户名" class="col-xs-10 col-sm-5" <% if (hallinfo != null) { %>value="<%= hallinfo.hallname %>"<% } %> />
                    </div>
				</div>
			</div>
            <div class="form-group" <% if (hallinfo != null) { %>style="display:none;"<% } %>>
				...
				<div class="col-sm-9">
                    <div class="clearfix">
					<input type="password" id="hallpwd" name="hallpwd" placeholder="请输入密码" class="col-xs-10 col-sm-5" />
                    </div>
				</div>
			</div>
            <div class="form-group" <% if (hallinfo != null) { %>style="display:none;"<% } %>>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
                    <div class="clearfix">
					<input type="text" id="nickname" name="nickname" placeholder="请输入代理名称" class="col-xs-10 col-sm-5"  <% if (hallinfo != null) { %>value="<%= hallinfo.nickname %>"<% } %>/>
                    </div>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
                    ...
                    <div class="clearfix">
					<input type="text" id="addrdetail" name="addrdetail" placeholder="请输入详细地址" class="col-xs-10 col-sm-5" <% if (hallinfo != null) { %>value="<%= hallinfo.addr %>"<% } %>/>
                    </div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9">
                    <div class="clearfix">
						<select class="select2" id="categorylist" name="categorylist" data-placeholder="Click to Choose...">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
                    <div class="clearfix">
					<input type="text" id="phone" name="phone" placeholder="请输入公司名称" class="col-xs-10 col-sm-5" <% if (hallinfo != null) { %>value="<%= hallinfo.phonenum %>"<% } %>/>
                    </div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9">
                    <div class="clearfix">
					<input type="text" id="email" name="email" placeholder="请输入公司名称" class="col-xs-10 col-sm-5" <% if (hallinfo != null) { %>value="<%= hallinfo.mail %>"<% } %>/>
                    </div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9">
                    <div class="clearfix">
					<input type="text" id="qqnumber" name="qqnumber" placeholder="请输入公司名称" class="col-xs-10 col-sm-5" <% if (hallinfo != null) { %>value="<%= hallinfo.qqnum %>"<% } %>/>
                    </div>
				</div>
			</div>
			...
			<div class="clearfix form-actions">
				<div class="col-md-offset-3 col-md-9">
					...
					&nbsp; &nbsp; &nbsp;
					<button class="btn" type="button" onclick="window.location='<%= ViewData["rootUri"] %>Hall/<% if (ViewData["uid"] != null) { %>EditHall/<%= ViewData["uid"] %> <% } else { %>AddHall <% } %> '">
	...
	<script type="text/javascript">
	    function redirectToListPage(status) {
	        if (status.indexOf("error") != -1) {
	            ...
	            window.location = rootUri + "Hall/HallList";
	        }
	    }
	    jQuery(function ($) {
	        //for edit//
