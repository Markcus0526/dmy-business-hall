	...
	<div class="col-xs-12">
		<form class="form-horizontal" role="form" id="validation-form">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
                    <div class="clearfix">
					<input type="password" id="userpwd" name="userpwd" placeholder="请输入密码" class="input-large form-control" <% if (userinfo != null) { %>value="<%= userinfo.userpwd %>"<% } %> />
                    </div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9">
                    <div class="clearfix">
					<input type="password" id="confirmpwd" name="confirmpwd" placeholder="请输入确认密码" class="input-large form-control" <% if (userinfo != null) { %>value="<%= userinfo.userpwd %>"<% } %> />
                    </div>
				</div>
			</div>
			<div class="form-group">
