			...
			<table id="tbldata" class="table table-striped table-bordered table-hover">
				<thead>
					<tr>
						...
						<th>用户名</th>
						<th>角色</th>
						<th class="hidden-480" style="width:150px;">创造时间</th>
						<th style="width:150px;">
							<i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i>
							最后登录时间
						</th>
						<th class="hidden-480" style="width:100px;">最后登录IP</th>
				...
				.dataTable({
				    ...
				    "aoColumnDefs": [
				        ...
				        },
				        {
				            ...
				            fnRender: function (o, v) {   // o, v contains the object and value for the column
				                var rst = '<a class="btn btn-xs btn-info" href="' + rootUri + 'User/EditUser/' + o.aData[6] + '">' +
